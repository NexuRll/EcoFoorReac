 ...
 */
export const validarEmpresa = (empresaData, empresasExistentes = []) => {
  const errores = {};
  ...
  if (!empresaData.rut || empresaData.rut.trim() === '') {
    ...
    empresasExistentes.some(e => e.rut.replace(/\./g, '').toLowerCase() === empresaData.rut.replace(/\./g, '').toLowerCase())
  ) {
  ...
  if (!empresaData.email || empresaData.email.trim() === '') {
    ...
    empresasExistentes.some(e => e.email.toLowerCase() === empresaData.email.toLowerCase())
  ) {
