          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="row">
                ...
                {/* Botón nuevo: Administrar Productos */}
                <div className="col-md-3 mb-3">
                  <Link to="/admin/productos" className="btn btn-outline-warning w-100 h-100 d-flex flex-column justify-content-center align-items-center p-3">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <ul className="list-unstyled mb-0">
                <li className="mb-2"><i className="fas fa-check text-success me-2"></i>Sistema funcionando correctamente</li>
                <li className="mb-2"><i className="fas fa-database text-info me-2"></i>Base de datos conectada</li>
                <li className="mb-2"><i className="fas fa-shield-alt text-warning me-2"></i>Autenticación activa</li>
                <li className="mb-0"><i className="fas fa-cloud text-primary me-2"></i>Firebase conectado</li>
              </ul>
            </div>
          </div>
        </div>
